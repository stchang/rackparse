...
;; A [ParseResult X] is a (ParseResult X Input)

(struct ParseResult (res next) #:transparent)

;; A [Parser X] is a function: Input -> [ListOf [ParseResult X]]
;;   where X is the type of the result, ie a Tree
;; A result of empty indicates error
...
(define (mk$nop v) (λ (inp) (list (ParseResult v inp))))
